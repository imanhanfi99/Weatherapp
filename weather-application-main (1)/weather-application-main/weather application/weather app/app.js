...
const apiKey= '48073d13d957fafc61ca7e83196ca44f'; 
...
button.addEventListener('click', function(){
    ...
    fetch(`http://api.openweathermap.org/data/2.5/weather?q=${input.value}&units=metric&appid=48073d13d957fafc61ca7e83196ca44f`)
